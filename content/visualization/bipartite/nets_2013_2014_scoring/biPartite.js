!function(){
	var bP={};	
	var b=35, bb=150, height=600, buffMargin=3, minHeight=20;
	var c1=[-100, 40], c2=[-50, 100], c3=[-10, 140]; //Column positions of labels.
	...
	function drawPart(data, id, p){
		...
		mainbar.append("rect").attr("class","mainrect")
			...
			.style("fill-opacity",0).style("stroke-width","2.5")
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Total").attr("x", (c2[d]-5))
				.attr("y", -5).style("fill","grey");
