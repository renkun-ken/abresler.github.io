!function(){
	var bP={};	
	var b=30, bb=175, height=450, buffMargin=5, minHeight=14;
	var c1=[-130, 45], c2=[-50, 110], c3=[-10, 150]; //Column positions of labels.
	var colors =["#3366CC", "#DC3912",  "#bfbf00","#171515", "#990099", "#0099C6"];
	...
	function drawPart(data, id, p){
		...
		mainbar.append("rect").attr("class","mainrect")
			...
			.style("fill-opacity",0).style("stroke-width","0.8")
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Total").attr("x", (c2[d]-10))
				.attr("y", -5).style("fill","grey");
